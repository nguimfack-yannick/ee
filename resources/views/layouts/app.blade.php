            ...
            <div class="grid grid-cols-1 md:grid-cols-4 gap-6 mb-6">
                ...
                <div class="md:col-span-2">
                    ...
                    <div class="flex space-x-3">
                        <a href="#" target="_blank" class="social-icon bg-white bg-opacity-20 p-1.5 rounded-full hover:bg-yellow transition-all duration-300">
                        ...
                        <a href="mailto:Contact@universalwelfare.org" class="social-icon bg-white bg-opacity-20 p-1.5 rounded-full hover:bg-yellow transition-all duration-300">
                ...
                <div>
                    ...
                    <div class="space-y-3 text-sm text-gray-200">
                        ...
                        <div class="flex items-center">
                            ...
                            <a href="mailto:Contact@universalwelfare.org" class="footer-link hover:text-yellow transition-all duration-300">Contact@universalwelfare.org</a>
                        </div>
                        <div class="flex items-center">
                            <svg class="w-4 h-4 mr-2 text-yellow" fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
