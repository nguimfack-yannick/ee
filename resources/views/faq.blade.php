...
<body class="bg-white font-sans antialiased font-all-bold">
    ...
    <div id="loading" class="fixed inset-0 bg-white bg-opacity-95 flex items-center justify-center z-50">
        <div class="relative w-20 h-20">
            ...
            <img src="/image/ab.png" alt="Logo ABEC" class="w-12 h-12 absolute top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2">
        </div>
    </div>
        ...
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div class="flex items-center justify-between h-10">
                <div class="flex items-center space-x-4">
                    <a href="#" target="_blank" class="hover:opacity-80 transition-opacity duration-300" title="Facebook">
                        <img src="/image/feacebook.jpg" alt="Facebook" class="w-6 h-6 rounded-full">
                    </a>
                    <a href="#" target="_blank" class="hover:opacity-80 transition-opacity duration-300" title="WhatsApp">
                        <img src="/image/wastapp.jpg" alt="WhatsApp" class="w-6 h-6 rounded-full">
                    </a>
                    <a href="#" target="_blank" class="hover:opacity-80 transition-opacity duration-300" title="Instagram">
                        <img src="/image/insta.jpg" alt="Instagram" class="w-6 h-6 rounded-full">
                    </a>
                </div>
                <a href="mailto:globaluniversalwelfare@gmail.com" class="hover:opacity-80 transition-opacity duration-300" title="Email">
                    <img src="/image/m.jpg" alt="Email" class="w-6 h-6 rounded-full">
                </a>
            </div>
        </div>
    </nav>
    ...
    <header class="bg-white shadow py-3 main-header">
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div class="flex items-center justify-between h-16">
                <div class="logo-container flex-shrink-0 flex justify-center items-center">
                    <img src="/image/ab.png" alt="logo" class="transition-transform duration-300 hover:scale-105 h-12 w-auto">
                </div>
                <nav class="hidden md:flex space-x-3">
                    <a href="#" class="px-2 py-1 rounded-md text-sm font-bold text-gray-800 hover:bg-blue-500 hover:text-white transition-all duration-300">Accueil</a>
                    ...
                    <a href="#" class="px-2 py-1 rounded-md text-sm font-bold text-gray-800 hover:bg-blue-500 hover:text-white transition-all duration-300">News</a>
                    ...
                    <a href="#" class="px-2 py-1 rounded-md text-sm font-bold text-gray-800 hover:bg-blue-500 hover:text-white transition-all duration-300">Dons</a>
                    <a href="#" class="px-2 py-1 rounded-md text-sm font-bold text-gray-800 hover:bg-blue-500 hover:text-white transition-all duration-300">Événements</a>
                </nav>
                <div class="md:hidden">
        ...
        <div id="mobileMenu" class="md:hidden px-2 pt-2 pb-3 space-y-1 mobile-menu hidden">
            <a href="#" class="block px-3 py-2 rounded-md text-sm font-bold text-gray-800 hover:bg-blue-500 hover:text-white transition-all duration-300">Accueil</a>
            ...
            <a href="#" class="block px-3 py-2 rounded-md text-sm font-bold text-gray-800 hover:bg-blue-500 hover:text-white transition-all duration-300">News</a>
            ...
            <a href="#" class="block px-3 py-2 rounded-md text-sm font-bold text-gray-800 hover:bg-blue-500 hover:text-white transition-all duration-300">Dons</a>
            <a href="#" class="block px-3 py-2 rounded-md text-sm font-bold text-gray-800 hover:bg-blue-500 hover:text-white transition-all duration-300">Événements</a>
        </div>
    </header>
                ...
                <div class="faq-item">
                    ...
                    <div class="faq-answer">
                        ...
                        <ul class="list-disc pl-5 mt-2 space-y-1">
                            <li><strong>Email :</strong> globaluniversalwelfare@gmail.com</li>
    ...
    <!-- Footer extrait du premier document -->
        ...
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
            ...
            <div class="grid grid-cols-1 md:grid-cols-4 gap-6 mb-6">
                ...
                <div class="md:col-span-2">
                    <div class="flex items-center mb-4">
                        <img src="/image/ab.png" alt="Logo ABEC" class="w-12 h-12 mr-3">
                        <div>
                    ...
                    <div class="flex space-x-3">
                        <a href="https://www.facebook.com/profile.php?id=61568266295634" target="_blank" class="social-icon bg-white bg-opacity-20 p-1.5 rounded-full hover:bg-yellow transition-all duration-300">
                            <img src="/image/feacebook.jpg" alt="Facebook" class="w-5 h-5">
                        </a>
                        <a href="https://whatsapp.com/channel/0029VaYTsNkD8SE42sDpnk1w" target="_blank" class="social-icon bg-white bg-opacity-20 p-1.5 rounded-full hover:bg-yellow transition-all duration-300">
                            <img src="/image/wastapp.jpg" alt="WhatsApp" class="w-5 h-5">
                        </a>
                        <a href="https://www.instagram.com/abec.officiel/" target="_blank" class="social-icon bg-white bg-opacity-20 p-1.5 rounded-full hover:bg-yellow transition-all duration-300">
                            <img src="/image/insta.jpg" alt="Instagram" class="w-5 h-5">
                        </a>
                        <a href="mailto:globaluniversalwelfare@gmail.com" class="social-icon bg-white bg-opacity-20 p-1.5 rounded-full hover:bg-yellow transition-all duration-300">
                            <img src="/image/m.jpg" alt="Email" class="w-5 h-5">
                        </a>
                    </div>
                </div>
                ...
                <div>
                    ...
                    <ul class="space-y-2 text-sm">
                        <li><a href="#" class="footer-link text-gray-200 hover:text-yellow flex items-center transition-all duration-300"><span class="mr-2">→</span> Accueil</a></li>
                        ...
                        <li><a href="#" class="footer-link text-gray-200 hover:text-yellow flex items-center transition-all duration-300"><span class="mr-2">→</span> News</a></li>
                        <li><a href="#" class="footer-link text-gray-200 hover:text-yellow flex items-center transition-all duration-300"><span class="mr-2">→</span> Faire un don</a></li>
                        <li><a href="#" class="footer-link text-gray-200 hover:text-yellow flex items-center transition-all duration-300"><span class="mr-2">→</span>Evenements</a></li>
                    </ul>
                </div>
                <!-- Colonne Contact -->
                <div>
                    ...
                    <div class="space-y-3 text-sm text-gray-200">
                        ...
                        <div class="flex items-center">
                            ...
                            <a href="#" class="text-gray-200 hover:text-yellow transition-all duration-300">FAQ</a>
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div class="bg-white bg-opacity-10 rounded-lg p-4 mb-6 backdrop-blur-sm">
                <div class="flex flex-col md:flex-row md:items-center justify-between">
                    ...
                    <a href="#" class="inline-block bg-yellow text-primary font-bold py-2 px-4 rounded-md hover:bg-opacity-90 transform hover:scale-105 transition-all duration-300 shadow-md">
                        Faire un don
                    </a>
                </div>
            </div>
            ...
            <div class="border-t border-white border-opacity-20 pt-4">
                <div class="flex flex-col md:flex-row justify-between items-center">
                    <p class="text-gray-300 text-xs mb-3 md:mb-0">
                        &copy; 2025 Association du Bien-Être Communautaire. Tous droits réservés.
                    </p>
