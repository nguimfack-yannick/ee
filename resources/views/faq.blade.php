...
<head>
    ...
    <title>FAQ - Association du Bien-Être Communautaire</title>
    <!-- Favicon -->
...
<body class="bg-white font-sans antialiased font-all-bold">
    ...
    <header class="bg-white shadow py-3 main-header">
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div class="flex items-center justify-between h-16">
                ...
                <nav class="hidden md:flex space-x-3">
                    <a href="{{ url('/') }}" class="px-2 py-1 rounded-md text-sm font-bold text-gray-800 hover:bg-blue-500 hover:text-white transition-all duration-300">Accueil</a>
                    <a href="{{ url('/') }}#actions" class="px-2 py-1 rounded-md text-sm font-bold text-gray-800 hover:bg-blue-500 hover:text-white transition-all duration-300">Nos Actions</a>
                    <a href="{{ url('/') }}#about" class="px-2 py-1 rounded-md text-sm font-bold text-gray-800 hover:bg-blue-500 hover:text-white transition-all duration-300">À propos</a>
                    ...
                    <a href="{{ url('/') }}#contact" class="px-2 py-1 rounded-md text-sm font-bold text-gray-800 hover:bg-blue-500 hover:text-white transition-all duration-300">Contact</a>
        ...
        <div id="mobileMenu" class="md:hidden px-2 pt-2 pb-3 space-y-1 mobile-menu hidden">
            <a href="{{ url('/') }}" class="block px-3 py-2 rounded-md text-sm font-bold text-gray-800 hover:bg-blue-500 hover:text-white transition-all duration-300">Accueil</a>
            <a href="{{ url('/') }}#about" class="block px-3 py-2 rounded-md text-sm font-bold text-gray-800 hover:bg-blue-500 hover:text-white transition-all duration-300">À propos</a>
            <a href="{{ url('/') }}#actions" class="block px-3 py-2 rounded-md text-sm font-bold text-gray-800 hover:bg-blue-500 hover:text-white transition-all duration-300">Nos Actions</a>
            ...
            <a href="{{ url('/') }}#contact" class="block px-3 py-2 rounded-md text-sm font-bold text-gray-800 hover:bg-blue-500 hover:text-white transition-all duration-300">Contact</a>
        ...
        <div class="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
            ...
            <div class="mt-8 space-y-4 text-left">
                ...
                <div class="faq-item">
                    ...
                    <div class="faq-answer">
                        Vous pouvez faire un don en toute sécurité via notre page <a href="{{ url('/dons') }}" class="text-primary hover:underline">Dons</a>. Nous acceptons les virements bancaires, mobile money et autres méthodes locales. Chaque contribution, quelle que soit sa taille, soutient directement nos actions sur le terrain.
                    </div>
                </div>
                ...
                <div class="faq-item">
                    ...
                    <div class="faq-answer">
                        Absolument ! Nous accueillons avec joie les bénévoles passionnés par notre mission. Envoyez-nous un message via nos contacts ou remplissez le formulaire sur notre page <a href="{{ url('/') }}#contact" class="text-primary hover:underline">Contact</a>. Ensemble, agissons pour un monde meilleur.
                    </div>
                </div>
            </div>
        </div>
...
<footer id="contact" class="bg-primary text-white relative pt-10 overflow-hidden section-animate">
    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        ...
        <!-- Ligne de séparation et copyright (SANS bordure) -->
        <div class="pt-4">
