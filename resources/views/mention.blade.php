    ...
    <main class="flex-1 py-8">
        <div class="legal-content" style="font-family: 'Arial Black', Arial, sans-serif; font-weight: bold;">
            ...
            <p class="text-gray-700 text-center">
                ...
                En accédant ou en utilisant notre site web (<a href="https://abec.org" class="text-primary hover:underline">abec.org</a>), vous acceptez les dispositions décrites dans ces Mentions Légales.
            </p>
            <p class="text-gray-700 text-center">
                Si vous avez des questions sur ces Mentions Légales, veuillez nous contacter à l'adresse  
                <a href="mailto:contact@abec.org" class="text-primary hover:underline">contact@abec.org</a>.
            </p>
            ...
            <ul class="list-disc mx-auto text-gray-700 text-center" style="list-style-position: inside;">
                ...
                <li><strong>Représentant légal</strong> : [Nom du Président ou Directeur Exécutif, à préciser].</li>
            ...
            <ul class="list-disc mx-auto text-gray-700 text-center" style="list-style-position: inside;">
                ...
                <li><strong>Hébergement du site</strong> : Le site <a href="https://abec.org" class="text-primary hover:underline">abec.org</a> est hébergé par [Nom de l'hébergeur], [adresse de l'hébergeur].</li>
            </ul>
            ...
            <ul class="list-disc mx-auto text-gray-700 text-center" style="list-style-position: inside;">
                ...
                <li><strong>Données personnelles</strong> : Voir notre <a href="{{ url('/privacy') }}" class="text-primary hover:underline">Politique de Confidentialité</a>.</li>
            ...
            <p class="text-gray-700 text-center">
                ...
                <a href="mailto:privacy@abec.org" class="text-primary hover:underline">privacy@abec.org</a>.
            </p>
            ...
            <ul class="list-disc mx-auto text-gray-700 text-center" style="list-style-position: inside;">
                <li><strong>Email</strong> : <a href="mailto:contact@abec.org" class="text-primary hover:underline">contact@abec.org</a></li>
